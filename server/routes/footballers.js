...
const Footballers   = require('../models/Football').Footballers;

/**
 * Functionality for this route:
 *  C   POST    /Footballers/        Create a new Football
 *  R   GET     /Footballers         Gets an array of all Footballers
 *  R   GET     /Footballers/:id     Get a single Football, by ID
 *  U   PUT     /Footballers/:id     Update a single Football, by id
 *  D   DELETE  /Footballers/:id     Delete a single Football, by ID
 */
